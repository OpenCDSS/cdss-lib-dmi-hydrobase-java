// ColoradoWaterHBGuest_GUI_StationGeolocMeasType_InputFilter_JPanel - input filter panel for stations
...
public class ColoradoWaterHBGuest_GUI_StationGeolocMeasType_InputFilter_JPanel
...
HydroBase_StationGeolocStructMeasType in the Java API, consistent with HydroBase.  This is used by TSTool.
Default filter panel properties are used (e.g., 3 filter groups).
@return a JPanel containing InputFilter instances for HydroBase_StationGeolocStructMeasType queries.
@param dataStore ColoradoWaterHBGuestDataStore instance.
@exception Exception if there is an error.
*/
public ColoradoWaterHBGuest_GUI_StationGeolocMeasType_InputFilter_JPanel (
...
/*
	...
	*/
	...
	setToolTipText ( "<html>ColoradoWaterHBGuest station queries can be filtered based on station data.</html>" );
