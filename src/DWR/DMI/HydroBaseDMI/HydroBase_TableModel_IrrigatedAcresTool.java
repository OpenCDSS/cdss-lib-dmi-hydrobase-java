// HydroBase_TableModel_IrrigatedAcresTool This class is a table model for
// displaying net amounts data in the HydroBase_GUI_OtherQuery GUI.
...
public final static int
	COL_YEAR = 0,
	COL_DIV = 1,
	COL_STRUCTURE_WDID = 2,
	COL_STRUCTURE_NAME = 3,
	COL_PARCEL_ID = 4,
	COL_PERIMETER = 5,
	COL_AREA = 6,
	COL_CROP_TYPE = 7,
	COL_IRRIG_TYPE = 8,
	COL_PERCENT_IRRIG =	9,
	COL_STRUCTURE_AREA = 10,
	COL_STRUCTURE_AREA_SUM = 11;
...
public Class getColumnClass (int columnIndex) {
	switch (columnIndex) {
		...
		case COL_STRUCTURE_WDID: return String.class;
		case COL_STRUCTURE_NAME: return String.class;
...
public String getColumnName(int columnIndex) {
	switch (columnIndex) {
		...
		case COL_DIV: return "\n\n\nDIV";
		case COL_STRUCTURE_WDID: return "\n\nSTRUCTURE\nWDID";
		case COL_STRUCTURE_NAME: return "\n\nSTRUCTURE\nNAME";
		...
		case COL_PERCENT_IRRIG: return "PARCEL\nPERCENT\nIRRIGATED\nBY STRUCTURE";
		case COL_STRUCTURE_AREA: return "PARCEL AREA\nIRRIGATED\nBY STRUCTURE\n(ACRE)";
		case COL_STRUCTURE_AREA_SUM: return "PARCEL AREA\nIRRIGATED\nBY STRUCTURE,\nSUM (ACRE)";
		default: return " ";
	}	
}
...
{	String[] tips = new String[__COLUMNS];
	...
	tips[COL_STRUCTURE_WDID] = "Diversion/ditch structure water district identifier.";
	tips[COL_STRUCTURE_NAME] = "Diversion/ditch structure name.";
	...
	tips[COL_PERCENT_IRRIG] = "Percent of parcel irrigated by the structure.";
	tips[COL_STRUCTURE_AREA] = "Parcel area irrigated by the structure.";
	tips[COL_STRUCTURE_AREA_SUM] = "Total parcel area irrigated by the structure, for the "
...
public int[] getColumnWidths() {
	...
	widths[COL_YEAR] = 4;
	widths[COL_DIV] = 3;
	widths[COL_STRUCTURE_WDID] = 8;
	widths[COL_STRUCTURE_NAME] = 20;
...
public String getFormat(int column) {
	switch (column) {
		...
		case COL_STRUCTURE_WDID: return "%-7s";
		case COL_STRUCTURE_NAME: return "%-32s";
...
public Object getValueAt(int row, int col) {
	...
	switch (col) {
		...
		case COL_STRUCTURE_WDID: return HydroBase_WaterDistrict.formWDID(pts.getStructureWD(), pts.getStructureID());
		case COL_STRUCTURE_NAME: return pts.getStructureName();
		...
		case COL_PERCENT_IRRIG: return Double.valueOf(pts.getPercent_irrig() * 100);
		case COL_STRUCTURE_AREA: return Double.valueOf(pts.getArea()*pts.getPercent_irrig());
		case COL_STRUCTURE_AREA_SUM:
			...
			int structure_num = pts.getStructure_num();
			...
			for ( int i = 0; i < _rows; i++ ) {
				...
				if ( pts2.getStructure_num() != structure_num ) {
					continue;
				}
