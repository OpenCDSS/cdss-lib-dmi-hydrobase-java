...
public class HydroBase_TableModel_WISFormat_WISImportWizard extends HydroBase_TableModel<HydroBase_WISFormat> {
...
*/
public HydroBase_TableModel_WISFormat_WISImportWizard(List<HydroBase_WISFormat> results) 
throws Exception {
	if (results == null) {
...
public Object getValueAt(int row, int col) {
	...
	HydroBase_WISFormat wf = _data.get(row);
	switch (col) {
