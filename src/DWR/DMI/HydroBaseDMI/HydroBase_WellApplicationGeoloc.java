// HydroBase_WellApplicationGeoloc - Class to hold data from the HydroBase well_application and geoloc tables.
...
// ----------------------------------------------------------------------------
// HydroBase_WellApplicationGeoloc.java - Class to hold data from 
//	the HydroBase well_application and geoloc tables.
// ----------------------------------------------------------------------------
// Copyright:   See the COPYRIGHT file
// ----------------------------------------------------------------------------
// History:
// 2003-02-13	J. Thomas Sapienza, RTi	Initial version from 
//					HBWellApplicationLocation.
...
/**
Class to store data from the HydroBase well_application and geoloc tables.
*/
public class HydroBase_WellApplicationGeoloc 
...
Constructor.
*/
public HydroBase_WellApplicationGeoloc() {
	super();
}
...
public String toString() {
	return "HydroBase_WellApplicationGeoloc {"		+ "\n" + 
		"Well_app_num:      " + _well_app_num + "\n" + 
		"Structure_num:     " + _structure_num + "\n" + 
		"Gw_controller_num: " + _gw_controller_num + "\n" + 
		"Geoloc_num:        " + _geoloc_num + "\n" + 
		"Subdiv_num:        " + _subdiv_num + "\n" + 
		"Receipt:           " + _receipt + "\n" + 
		"Pyield:            " + _pyield + "\n" + 
		"Pdepth:            " + _pdepth + "\n" + 
		"Pacreft:           " + _pacreft + "\n" + 
		...
		"Trancode:          " + _trancode + "\n" + 
		"Trandate:          " + _trandate + "\n" + 
		"Permit_type_num:   " + _permit_type_num + "\n" + 
		"Permitno:          " + _permitno + "\n" + 
