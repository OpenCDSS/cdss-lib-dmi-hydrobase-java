// TSTool_HydroBase_CASSLivestockStats_TableModel - table model for time series header information for HydroBase
...
extends JWorksheet_AbstractRowTableModel<HydroBase_AgriculturalCASSLivestockStats>
{
...
public TSTool_HydroBase_CASSLivestockStats_TableModel ( JWorksheet worksheet,
	List<HydroBase_AgriculturalCASSLivestockStats> data, String data_type_prefix )
throws Exception
{	if ( data == null ) {
		_rows = 0;
	}
...
{	// make sure the row numbers are never sorted ...
	...
	HydroBase_AgriculturalCASSLivestockStats ag = _data.get(row);
	switch (col) {
