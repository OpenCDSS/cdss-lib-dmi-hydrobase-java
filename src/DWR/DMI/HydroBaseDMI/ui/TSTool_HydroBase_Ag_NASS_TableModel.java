...
public class TSTool_HydroBase_Ag_NASS_TableModel
extends JWorksheet_AbstractRowTableModel<HydroBase_AgriculturalNASSCropStats>
{
...
*/
public TSTool_HydroBase_Ag_NASS_TableModel ( JWorksheet worksheet, List<HydroBase_AgriculturalNASSCropStats> data, String data_type_prefix )
throws Exception
{	if ( data == null ) {
		_rows = 0;
	}
...
{	// make sure the row numbers are never sorted ...
	...
	HydroBase_AgriculturalNASSCropStats ag = _data.get(row);
	switch (col) {
