// HydroBase_AdministrationNumber - class to store and manipulate an administration number
...
//------------------------------------------------------------------------------
// HydroBase_AdministrationNumber - class to store and manipulate 
...
public final class HydroBase_AdministrationNumber {
...
*/
public HydroBase_AdministrationNumber ( DateTime appro_date )
throws Exception
{
...
@exception Exception if an error occurs
*/
public HydroBase_AdministrationNumber(DateTime appro_date, DateTime prior_adj_date )
throws Exception
{
	// The following throws an exception...
...
@exception Exception if an error occurs
*/
public HydroBase_AdministrationNumber ( double admin_number )
throws Exception
{
...
@exception Exception if an error occurs
*/
public HydroBase_AdministrationNumber ( int admin_number )
throws Exception
{
	// The following throws Exception...
...
*/
public boolean equals ( HydroBase_AdministrationNumber a )
{
...
*/
public boolean greaterThan ( HydroBase_AdministrationNumber a )
{
	if ( _whole > a._whole ) {
...
@param a Administration number to check.
*/
public boolean lessThan ( HydroBase_AdministrationNumber a )
{
	if ( equals(a) ) {
		return false;
	}
...
} // End HydroBase_AdministrationNumber class
