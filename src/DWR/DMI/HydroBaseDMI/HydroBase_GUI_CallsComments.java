// HydroBase_GUI_CallsComments - GUI for changing the comments and districts affected for a given call.
...
/**
This class is a modal dialog from which Calls comments can be changed and the changes written to a database.
*/
...
@param release_comments the call's release_comments as displayed in the parent GUI.
@param districts_affected the call's districts_affected as displayed in the parent GUI.
@param released if true, the call has been released.  If false, it is still active.
*/
...
private void okClicked() {
	...
	String districtsAffected = __districtsAffectedJTextField.getText().trim();
	...
	String message = "Some fields are too long to fit within the database columns.\nThey will be truncated as follows:";
	boolean error = false;
