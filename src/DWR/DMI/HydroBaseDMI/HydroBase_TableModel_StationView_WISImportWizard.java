...
public class HydroBase_TableModel_StationView_WISImportWizard extends HydroBase_TableModel<HydroBase_StationView> {
...
*/
public HydroBase_TableModel_StationView_WISImportWizard(List<HydroBase_StationView> results) 
throws Exception {
	if (results == null) {
...
public Object getValueAt(int row, int col) {
	...
	HydroBase_StationView view = _data.get(row);
	switch (col) {
		case COL_SGMT_NAME:		
